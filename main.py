...
class Employee:
    def __init__(self, root):
        ...
        # empimg3
        img_3 = Image.open(r"C:\Users\Sarbjeet\PycharmProjects\EMS\Ems images\img1.png")
        ...
        # empimg4
        img_4 = Image.open(r"C:\Users\Sarbjeet\PycharmProjects\EMS\Ems images\ww.jpg")
...
#
    ...
    #     #********* Employee Table *********
        ...
        "dep", "name", "designation", "email", "address", "married", "dob", "doj", "idproofcomb", "idproof", "gender", "phone",
    ...
    def add_data(self):
        if self.var_dep.get() == "" or self.var_email.get() == "":
            messagebox.showerror('Error', 'All fields are required')
             ...
             try:
            #     conn = mysql.connector.connect(user='root', password='Sarb@2001', host='localhost', port='3306',
            #                                    database='employeeform', auth_plugin='mysql_native_password')

                conn = mysql.connector.connect(user='root', password='Sarb@2001', host='localhost',
                                               database='employeeform',auth_plugin='mysql_native_password')
...
#     # Fetch Table
    def fetch_data(self):
        # conn = mysql.connector.connect(user='root', password='Sarb@2001', host='127.0.0.1', port='3306',
        #                                database='employeeform', auth_plugin='mysql_native_password')
        ...
        if self.var_dep.get() == "" or self.var_email.get() == "":
            ...
            try:
                ...
                if update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        'update employee set dep=%s,name=%s,designation=%s,email=%s,address=%s,married=%s,dob=%s,doj=%s,idproofcomb=%s,gender=%s,phone=%s,country=%s,salary=%s where idproof=%s',
                        (self.var_dep.get(), self.var_name.get(), self.var_designation.get(), self.var_email.get(),
                         self.var_address.get(), self.var_married.get(), self.var_dob.get(), self.var_doj.get(),
